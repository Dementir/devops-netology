...
> Почему вы так решили про exe?  
/proc/[pid]/exe это указатель на область памяти где хранится исполняемый файл в памяти

> Что такое proc/<PID>/cmdline?
